...
def get_data_from_link(update: Update, _: CallbackContext):
    ...
    if validators.url(photo_url):
        ...
        update.message.reply_text("Wrong url format!")


def get_data_from_photo(update: Update, context: CallbackContext):
